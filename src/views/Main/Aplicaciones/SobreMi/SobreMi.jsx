...
import EstiloSobreMi from "./EstiloSobreMi";

function SobreMi({ encabezado }) {
  return (
    <section style={EstiloPrincipal.enLinea.subContenedor}>
      ...
      {/*  <div id="resumen">
        ...
        <div>
          <img src="" alt="" />
          <span>
            Soy un desarrollador de PHP con más de una década de experiencia,
            especializado en desarrollo backend y con algo de experiencia en
            frontend. También tengo experiencia práctica en entornos de
            producción con C++, C#, Go y Python. Este variado historial me
            permite adaptarme a una amplia gama de necesidades de proyectos.
      ...
      <div id="intereses">
        <div id="tarjeta">
          ...
          <div id="contenido-tarjeta">
            <h4>Tocar la guitarra</h4>{" "}
            <span>
              Explorando diferentes gfeneros mejorando mis habilidades
            </span>
          </div>
        </div>
      </div> */}
