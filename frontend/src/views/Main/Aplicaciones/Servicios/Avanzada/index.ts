/**
 * Módulo Avanzada — Cotizador Avanzado
 *
 * Este directorio contiene el cotizador avanzado con:
 * - Pasos detallados para configurar proyectos
 * - Selección granular de módulos y servicios
 * - Ajustes comerciales complejos
